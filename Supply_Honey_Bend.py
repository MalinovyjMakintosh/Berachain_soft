...
def supply_honey_bend(account):
    address = account.address
    nonce = w3.eth.get_transaction_count(address)
    amount = round(random.uniform(0.001, 0.003), 4) #рандомное значение от 0.0001 до 0.001
    amount_out = int(amount * 10 ** 18) 
    transaction = contract.functions.supply('0x7EeCA4205fF31f947EdBd49195a7A88E6A91161B', amount_out,  address, 0).build_transaction({
    ...
    transaction_hash4 = w3.eth.send_raw_transaction(signed_swap_txn.rawTransaction)
    return transaction_hash4
